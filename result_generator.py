from cal_methods import apply_calibration_and_evaluate
...
class DataSetProcessor:
    ...
    def process_datasets(self):
        ...
        for validation_file in validation_files:
            base_name = validation_file.replace('validations_with_scores_', '')
            corresponding_test_file = 'tests_with_scores_' + base_name
...
def save_results(results_df):
    ...
    output_dir = os.path.join('path/to/output_directory', 'evaluation_results_paper_2_')
...
if __name__ == "__main__":
    base_path = 'path/to/results_folder'  # Specify the directory containing your CSV files
